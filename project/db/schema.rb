...
ActiveRecord::Schema.define(version: 2018_06_02_124403) do
  ...
  create_table "countries_target_groups", id: false, force: :cascade do |t|
    ...
    t.index ["country_id", "target_group_id"], name: "index_country_target_group"
    t.index ["target_group_id", "country_id"], name: "index_target_group_country"
  end
  ...
  create_table "location_groups_locations", id: false, force: :cascade do |t|
    ...
    t.index ["location_group_id", "location_id"], name: "index_location_group_location"
    t.index ["location_id", "location_group_id"], name: "index_location_location_group"
  end
